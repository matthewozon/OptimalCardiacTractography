...
class C_parametric_comparison
{
    public:
        ...
        double getMeanDist3(string fileNameFib, bool spl); ///OK This was the measure used for comparision: similarity
        double getMeanDist4(string fileNameFib, bool spl); ///OK This is the angle accuracy: mean angle
