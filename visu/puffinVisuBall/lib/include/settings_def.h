...
#define COOLING_LOG       2
#define COOLING_LIN       3

//energy settings
#define U1    10L
//#define U13_2 40L ///scalar product normed + angle sigmoid
#define U15   50L ///scalar product normed over mean edge pairs + angle sigmoid
#define U16   60L ///scalar product normed over mean edge pairs + angle sigmoid + border effect (phi0 and phi1)
#define U17   70L ///scalar product normed over mean edge pairs + angle sigmoid (increasing weight)
...
#define SA_LOG_COOLING        COOLING_LOG
#define SA_LIN_COOLING        COOLING_LIN
...
#define SC_LOG_COOLING        COOLING_LOG
#define SC_LIN_COOLING        COOLING_LIN

#define SC_U1  U1
#define SC_U13_2 U13_2
#define SC_U15 U15
#define SC_U16 U16
#define SC_U17 U17
#define SC_U18 U18
